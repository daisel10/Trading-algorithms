...
metadata:
  author: prowler-cloud
  version: "1.0"
  scope: [root]                                    # Which AGENTS.md: domain, proto, core, api, web, root

  # Option A: single action
  auto_invoke: "Creating/dockerfile"
...
| `kairos-core` | `apps\kairos-core\.ai\00_MAIN.md` |
| `kairos-api` | `apps\kairos-api\.ai\00_MAIN.md` |
| `kairos-web` | `apps\kairos-web\.ai\00_MAIN.md` |
| `kairos-domain` | `libs\kairos-domain\.ai\00_MAIN.md` |
| `kairos-proto` | `libs\kairos-proto\.ai\00_MAIN.md` |
...
1. Reads all `skills/*/SKILL.md` and `*/00_MAIN.md` files
...
metadata:
  ...
  version: "1.0"
  scope: [root]
  auto_invoke: "Creating/modifying dockerfiles"
```

The sync script generates in `kairos-core/.ai/00_MAIN.md`:
...
| Action | Skill |
|--------|-------|
| Creating/modifying dockerfiles | `root ` |
```
